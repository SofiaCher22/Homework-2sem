...
def reconstruct_from_prefix(prefix_func):
    if not prefix_func:
        return ""
...
prefix_func = [0, 0, 1, 0, 1, 2, 3]
result = reconstruct_from_prefix(prefix_func)
print("Восстановленная строка:", result) 
print(suff_array(result))